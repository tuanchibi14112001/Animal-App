...
class AnimalTypeFragment : Fragment() {
    ...
    private lateinit var binding: FragmentAnimalTypeBinding
    ...
    override fun onCreateView(
        ...
        savedInstanceState: Bundle?
            ...
            binding = FragmentAnimalTypeBinding.inflate(inflater, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment AnimalTypeFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            AnimalTypeFragment().apply {
